    ...
    <div class="navbar-container" id="navbar-container">
        ...
        <div class="navbar-header pull-right" role="navigation">
            <ul class="nav ace-nav">
                ...
                <li class="light-blue">
                    <a data-toggle="dropdown" href="http://localhost:8088/cust/goods/list#" class="dropdown-toggle">
        ...
        <div class="sidebar" id="sidebar">
            ...
            <ul class="nav nav-list">
                ...
                <li class="active open">
                    <a href="http://localhost:8088/cust/goods/list#" class="dropdown-toggle">
                        <i class="icon-list"></i>
                    ...
                    <ul class="submenu">
                        <li class="active">
                            <a href="http://localhost:8088/cust/goods/list">
        ...
        <div class="main-content">
            <div class="breadcrumbs" id="breadcrumbs">
                ...
                <div class="nav-search" id="nav-search">
                    <form name="formSelect" method="post" action="http://localhost:8088/cust/goods/list">
                                ...
                                <div class="table-responsive">
                                    <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <td class="left"><a href="http://localhost:8088/cust/goods/list#" onclick="window.location.href='/cust/goods/add?good_id=14886110'">${goods.goodName}</a></td>
            ...
            <a href="http://localhost:8088/cust/goods/list#" id="btn-scroll-up" class="btn-scroll-up btn btn-sm btn-inverse">
